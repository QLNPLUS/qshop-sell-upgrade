...
- forge-1.20.1：Forge 1.20.1，已实现并通过构建验证。
- neoforge-1.21.1：NeoForge 1.21.1，已实现并通过构建验证。
- neoforge-1.26.1.2：NeoForge 26.1.2，已实现并通过构建验证。
...
两个升级也会显示在精妙背包的创造模式物品分页中。普通售卖升级提供 3x3 个筛选格，高级售卖升级提供 4x4 共 16 个筛选格。

## 许可

All Rights Reserved（ARR）。详见 LICENSE。
